...
<head>
    ...
    <link href="source/assets/plugins/material-preloader/css/materialPreloader.min.css" rel="stylesheet">
                            ...
                            <div class="row">
                                <form class="col s12" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="col s12 right-align m-t-sm">
                                        <a href="{{ route('register') }}" class="waves-effect waves-grey btn-flat">{{ __('Register') }}</a>
                                    ...
                                    <div class="col s12 right-align m-t-sm">
                                        @if (Route::has('password.request'))
                                            <a class="btn1 btn1-link" href="{{ route('password.request') }}">
